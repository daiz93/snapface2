...
import { interval,  Observable,filter, of } from 'rxjs';
...
export class AppComponent  implements OnInit{
  ...
  ngOnInit(): void {
    /* const interval$ = interval(1000); //creat an observable
    interval$.subscribe(value => console.log(value)); // subscrib to an observable
